...
function App() {
  return (
    <>
      <a
        href='#main-content'
        className='absolute left-2 top-0 z-999 bg-primary-500 text-white py-2 px-4 -translate-y-full focus:translate-y-2 transition ease-out focus:outline-2 outline-primary-500 outline-offset-2 rounded'
      >
              ...
              <Routes>
                ...
                >
                  ...
                  <Route path='diplomatic' element={<DiplomaticLayout />}>
                    ...
                    <Route
                      path='missions'
                      element={<DiplomaticMissionsPage />}
                    />
